...
VimTeX requires Vim version 8.1.1705 or Neovim version 0.9.5. This fork lowers
the requirement to the actual feature floor used by the code (the `..` operator
and `#{}` literal-dict syntax, both Vim 8.1). If you are stuck on older versions
of Vim or Neovim, then you should not use the most recent version of VimTeX, but
instead remain at the v2.17 tag (or older).
